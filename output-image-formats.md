...
Вихідний формат PNG (.png) з 8-бітовим (цифрове значення пікселя 0 - 255) розширенням. Безвтратне стиснення, придатне для перегляду та візуалізації в Інтернеті.
