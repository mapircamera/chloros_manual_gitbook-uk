---
description: Панелі, виміряні в лабораторії, використовуються для калібрування зібраних даних під час постобробки.
metaLinks:
  alternates:
