...
* **Інтерактивне налаштування LUT** — точне налаштування градієнтів та діапазонів кольорів
...
* **Середні класи (6-10)**: загальний аналіз, збалансовані деталі, стандартні звіти
...
* **Мінімальне значення**: нижня межа кольорової шкали
...
* **Виділення незначних відмінностей** у вузькому діапазоні значень
...
#### **Доступні опції режимів обрізання:**
...
* Пікселі **поза діапазоном** відображаються в **відтінках сірого** (показують вихідні значення індексу)
...
* **Приклад**: Перегляньте фактичний вигляд поля/посівів з накладеними кольоровими кодами для зон стресу.

### Вибір правильного режиму обрізки

| Режим обрізки              | Найкраще підходить для                                   | Стиль візуалізації          |
| -------------------------- | ------------------------------------------ | ---------------------------- |
| **Мінімальне та максимальне**    | Повний відображення даних, науковий аналіз     | Всі пікселі кольорові           |
...
Для повного контролю над візуалізацією ви можете створити **власні кольорові градієнти**, редагуючи окремі колірні зупинки.
...
3. **Клацніть колірну зупинку**, щоб вибрати її.
...
**Додавання або видалення зупинок кольорів:**
...
{% hint style=&quot;success&quot; %}
**Миттєвий зворотний зв&#x27;язок**: Миттєвий візуальний зворотний зв&#x27;язок дозволяє швидко експериментувати з різними налаштуваннями, поки ви не знайдете оптимальну візуалізацію для своїх потреб аналізу.
{% endhint %}
...
2. Перейдіть до **випадаючого меню «Формула індексу»**.
3. Знайдіть опцію **«Користувацький»**. (необхідно увійти з ліцензією Chloros+)
...
Тепер, коли ви розумієте, що таке пісочниця індексів/LUT:
