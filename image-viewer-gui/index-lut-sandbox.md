...
Пісочниця забезпечує:

* **Розрахунок індексів у реальному часі** — миттєве застосування будь-якого індексу рослинності
* **Інтерактивне налаштування LUT** — точне налаштування градієнтів і діапазонів кольорів
...
* Часомісткий процес
* Найкраще підходить, коли параметри остаточно визначені
...
Коли зображення відкриється на весь екран і бічна панель **Переглядач зображень** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> відкрита:
...
* Шкала сірих відтінків: наукова та нейтральна, показує необроблені дані
...
* **20+ класів**: майже безперервні, максимальна плавність
...
* **Більше класів** (15-20): Плавний перехід, детальні варіації, фотографічний вигляд
...
* **Індивідуальний діапазон**: налаштувати на основі спостережуваних значень пікселів
...
* **Приклад використання**: підкреслити крайні значення, показати повний діапазон даних із насиченими кольорами на межі
* **Приклад**: значення NDVI нижче 0,2 відображаються червоним, значення вище 0,9 відображаються зеленим
...
* **Приклад**: показувати тільки NDVI 0,4-0,7 у кольорі, все інше прозоре
...
* Пікселі **в діапазоні** показують **градієнт кольорів**
...
* Пікселі **в межах діапазону** відображають **кольоровий градієнт**
* **Випадок використання**: найбільш інтуїтивний — поєднує природний контекст зображення з аналітичним кольоровим накладенням
* **Приклад**: перегляд фактичного вигляду поля/посівів з накладеними кольоровими позначками стресованих ділянок
...
5. Виберіть новий колір за допомогою:
   ...
   * **Повзунки RGB/HSV**: точне керування кольором
   * **Введення шестнадцяткового коду**: точне визначення кольору (наприклад, `#FF0000` для червоного)
6. Клацніть поза палітрою кольорів, **щоб застосувати новий колір**
7. Градієнт **негайно оновлюється** на зображенні

**Додавання або видалення колірних зупинок:**

* **Додати зупинку**: натисніть на значок +, щоб додати новий зразок в кінці
* **Видалити зупинку**: двічі клацніть на кольоровому квадраті, щоб видалити зразок

**Стратегії налаштування:**

* **Інвертувати градієнт**: переверніть порядок кольорів, щоб змінити значення (наприклад, зелений = низький, червоний = високий)
* **Кольори бренду**: підберіть кольори звітів відповідно до колірної палітри вашої організації
* **Придатність для людей з кольоровою сліпотою**: використовуйте поєднання помаранчевого та синього або фіолетового та жовтого кольорів
* **Оптимізація друку**: вибирайте кольори, які підходять як для кольорового, так і для чорно-білого друку
* **Багатопороговий**: використовуйте різні кольори для конкретних порогових значень для класифікації

{% hint style=&quot;info&quot; %}
**Збереження власних градієнтів**: власні градієнти можна зберігати та використовувати повторно. Клацніть піктограму збереження на панелі LUT, щоб зберегти власні колірні схеми для подальшого використання.
{% endhint %}
...
* **Модифікація обрізки** → Відображення фону змінюється миттєво
* **Редагування кольорів** → Налаштований градієнт застосовується негайно

**Не потрібно натискати кнопку «Застосувати»** — усі зміни відбуваються в режимі реального часу та інтерактивно!

{% hint style=&quot;success&quot; %}
**Миттєвий зворотний зв&#x27;язок**: Миттєвий візуальний зворотний зв&#x27;язок дозволяє швидко експериментувати з різними налаштуваннями, поки ви не знайдете оптимальну візуалізацію для своїх потреб в аналізі.
{% endhint %}
...
2. **Наведіть курсор** на різні області зображення
3. **Спостерігайте за значеннями пікселів**, що відображаються в легенді при наведенні курсору
...
5. **Запишіть** діапазони значень для різних характеристик:
   ...
   * **Вода** (якщо є): наприклад, NDVI від -0,05 до 0,10
