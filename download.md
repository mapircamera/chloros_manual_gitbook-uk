...
6. Увійдіть за допомогою облікового запису MAPIR Cloud Chloros+ (або продовжуйте користуватися безкоштовною версією).
...
* 🧮 **Налаштовувані формули** - Створення налаштовуваних мультиспектральних індексів

<p align="center"><a href="https://cloud.mapir.camera/pricing" class="button primary">Переглянути Chloros+ Тарифи та ціни</a></p>***
