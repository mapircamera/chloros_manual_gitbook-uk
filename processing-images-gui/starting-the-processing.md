...
* Не потрібно втручання користувача
...
* Перегляньте та виправте всі проблеми
* Відкоригуйте налаштування за потреби
* Почніть обробку спочатку
* Для найчистішого досвіду повністю закрийте Chloros і перезапустіть
...
2. **Тримайте Chloros на передньому плані** — або принаймні видимим на панелі завдань.
