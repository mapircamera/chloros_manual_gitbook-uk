...
* [ ] **Моделі камер виявлено** — у стовпці «Модель камери» відображаються правильні камери
* [ ] **Налаштування сконфігуровано** — налаштування проекту переглянуто та скориговано
* [ ] **Індекси вибрано** — додано бажані мультиспектральні індекси (за потреби)
* [ ] **Формат експорту вибрано** — вихідний формат, відповідний для вашого робочого процесу
...
### Знайдіть кнопку «Почати»

Кнопка «Почати/Відтворити» розташована у верхній панелі заголовка Chloros:

* Розташування: у верхній центральній частині вікна
* Піктограма: **кнопка «Відтворити/Почати»** <img src="../.gitbook/assets/image (2) (1).png" alt="" data-size="line">
...
Chloros працює в двох різних режимах обробки залежно від вашої ліцензії:
...
4. **Експорт** — збереження оброблених зображень та індексів**Взаємодія з індикатором прогресу:*** **Наведіть курсор миші** на індикатор, щоб побачити детальну 4-етапну випадаючу панель
* **Клацніть** на індикаторі прогресу, щоб зафіксувати випадаючу панель на місці
* **Клацніть ще раз**, щоб розморозити та приховати панель**Час обробки:**
...
{% hint style=&quot;info&quot; %}
**Chloros+ Швидкість**: Паралельна обробка може бути в 5-10 разів швидшою, ніж послідовний режим для великих наборів даних. Проект із 500 зображеннями, який у безкоштовному режимі займає 2 години, може бути виконаний за 15-20 хвилин із Chloros+.
{% endhint %}
...
**Що робить Chloros:*** **Корекція віньєтування**: усуває затемнення об&#x27;єктива по краях
...
* Уникайте запуску інших завдань, що вимагають інтенсивного використання процесора
...
* У разі скасування необхідно розпочати обробку спочатку.
...
* **Переглядати індикатор прогресу** — бачити загальний відсоток виконання
...
{% hint style=&quot;warning&quot; %}
**Без часткових результатів**: Скасування відкидає весь прогрес. Chloros не зберігає частково оброблені зображення.
{% endhint %}
...
* Режиму обробки (Безкоштовний або Chloros+)
* Швидкості та кількості ядер процесора
* Наявності графічного процесора (тільки Chloros+)
...
### Кнопка «Запустити» неактивна (сіра)

**Можливі причини:**

* Не імпортовано жодного зображення
...
3. Перевірте, чи цілі видимі на позначених зображеннях
4. За необхідності відкоригуйте налаштування виявлення цілей
...
4. Контролюйте температуру GPU (забезпечте достатнє охолодження)
