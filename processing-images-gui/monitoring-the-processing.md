...
* **Клацніть** на індикаторі прогресу, щоб зафіксувати/закріпити розгорнуту панель
...
4. **Перегляньте оброблені зображення** — використовуйте переглядач зображень або зовнішнє програмне забезпечення
